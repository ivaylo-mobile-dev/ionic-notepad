...
export class NotesService {
  ...
  load(): Promise<boolean> {
    ...
    // Return a promise so that we know this operation has completed
    return new Promise((resolve) => {
      ...
      this.storage.get('notes').then((notes) => {
        ...
        // This allows us to check if data has been loaded in or not
        this.loaded = true;
        resolve(true);
  ...
  deleteNote(note): void {
    // Get the index in the array of the notes that was passed in
